      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=> setMethod('applepay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'applepay' ? 'bg-green-400' : ''}`}></p>
              <img className='h-5 mx-4' src={assets.applePay_logo} alt="" />
            </div>
            <div onClick={()=> setMethod('pod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'pod' ? 'bg-green-400' : ''}`}></p>
